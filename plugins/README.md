...
|--------|-------------|-------|
| [notify](./notify) | Phone push notifications (via ntfy.sh) when Claude Code stops and awaits you, asks a multiple-choice question, or hits a permission prompt — with the session name as the text. | 1 skill + session-wide hooks (Stop / AskUserQuestion / PermissionRequest) |
